...
print("Best parameters of SVC model with gridseach function: ", best_parm_grid)
print("Best score of SVC model gridsearch function: ", best_score_grid )
print("---------------------------------")
#%% LogisticRegression
...
print("LogisticRegression Score: ", logr.score(X_test, y_test))
print(bas_log.mean())
print(bas_log.std())
print("---------------------------------")
# %% KNN
...
print("Best prameter of KNN with gridseach function: ", best_parm_grid_knn)
print("Best score of KNN with gridsearch function: ",best_score_grid_knn)
print("---------------------------------")
...
print("BernoulliNB Score: ", gnb.score(X_test, y_test))
print(bas_na.mean())
print(bas_na.std())
print("---------------------------------")
...
print("Best prameter of DecisionTreeClassifier with gridseach function: ", best_parm_grid_dtc)
print("Best score of DecisionTreeClassifier with gridsearch function: ",best_score_grid_dtc)
print("---------------------------------")
